...
[`site/docs/contributing.md`](../../../site/docs/contributing.md). This skill only drives the stable cut, so that
...
```sh
for p in imprnt imprnt-plugin-anti-slop imprnt-plugin-character imprnt-plugin-timemachine; do
...
[`site/docs/contributing.md`](../../../site/docs/contributing.md#rollback):
```sh
