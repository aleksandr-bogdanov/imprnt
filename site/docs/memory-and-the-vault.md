...
Each loaded differently: always on, on demand, and capture-then-review. The responsibilities overlapped too. USER and KNOWLEDGE both answered "who am I and what am I working on." Two stores under MEMORY/ served opposite ends, one curated and permanent, one raw and temporal. The practical cost was a simple one: you could rarely say where a given fact lived or whether the assistant would see it.
