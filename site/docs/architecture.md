...
imprnt is plain **markdown** files on your computer. No database, no cloud, no app to log into. You talk to your assistant and it drives imprnt underneath: it files what you tell it and recalls what you ask. The command-line engine is the thing the assistant runs for you.
...
When you ask your assistant to file a source, it runs one pass of four steps. Only one spends the model:
