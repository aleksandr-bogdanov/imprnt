...
**Status (checked 2026-08-27):** active - repo `affaan-m/ECC` pushed 2026-08-25, releases from v1.0.0 (2026-01-22) to v2.1.0 (2026-07-27). Effectively a one-maintainer project (Affaan Mustafa) with a very large surface area, funded by a $19/seat hosted tier and sponsors. GitHub API: `archived: false`, `pushed_at: 2026-08-25T21:27:27Z`. [api.github.com/repos/affaan-m/ECC](https://api.github.com/repos/affaan-m/ECC) - accessed 2026-08-27.

**Latest release:** v2.1.0, 2026-07-27 | **Stars:** 243,489 | **License:** MIT | **Hosting:** local (the OSS core), plus an optional hosted GitHub App (ECC Pro, $19/seat/month at ecc.tools)

**Re-check 2026-08-27:** stars 225,052 -> 243,489, release v2.0.0 -> v2.1.0 (2026-07-27, [release notes](https://github.com/affaan-m/ECC/releases/tag/v2.1.0), accessed 2026-08-27). v2.1.0 is Plan Canvas (browser plan review), a Kimi Code install target plus Hermes and OpenClaw targets, and sponsored GPU-compute wiring. The memory subsystem is unchanged in kind (session summaries plus instincts, recency injection, no search): the one memory-adjacent line is "configurable instinct injection (count + confidence threshold)", so the fixed up-to-6 / confidence >= 0.7 defaults described below are now knobs. Catalog drifted again: "67 agents, 281 skills, and 94 command shims" per the release body. Verdict unchanged.
