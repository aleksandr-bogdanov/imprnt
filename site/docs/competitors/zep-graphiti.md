...
**Status (checked 2026-08-27):** active - both alive and shipping. Graphiti repo `getzep/graphiti` pushed 2026-08-26, latest release v0.29.3 published 2026-07-27, `archived: false`. GitHub API reports `pushed_at: 2026-08-26T18:28:50Z`, `archived: false`, 30,321 stars ([api.github.com/repos/getzep/graphiti](https://api.github.com/repos/getzep/graphiti), accessed 2026-08-27). Zep Cloud is a live commercial product with a public pricing page and active blog ([getzep.com/pricing](https://www.getzep.com/pricing), accessed 2026-07-02). Note: the self-hostable Zep server (Community Edition) is dead - "Community Edition, which allows you to host Zep locally, is deprecated and no longer supported" ([help.getzep.com/faq](https://help.getzep.com/faq), re-confirmed 2026-08-27). Graphiti is the only open-source path that remains.

**Latest release:** v0.29.3, 2026-07-27 | **Stars:** 30,321 | **License:** Apache-2.0 | **Hosting:** both (Graphiti self-host on Apache-2.0, Zep cloud SaaS / enterprise BYOC)

**Re-check 2026-08-27:** stars 28,283 -> 30,321, release v0.29.2 -> v0.29.3 (2026-07-27, [releases](https://github.com/getzep/graphiti/releases), accessed 2026-08-27). The v0.29.3 body is dependency bumps, CI hardening, and FalkorDB Docker fixes, with no architecture or retrieval change. The Community Edition deprecation was re-verified verbatim against the live FAQ on 2026-08-27. Verdict unchanged.
