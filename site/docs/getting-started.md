...
You never type these commands in normal use. Your **assistant** runs them for you. They are here so you can see what happens and drive it yourself when you want.
...
Want the vault elsewhere? Point one variable at it and everything follows.
...
- `imp lair` opens Claude inside the **vault** itself. The full contract loads there, and your personal chats pile up in one place you can resume.
