...
<DesignFlipsIf>A plugin ever needs a core edit to install, which is the exact signal that the dependency arrows have started pointing the wrong way again.</DesignFlipsIf>
